...
Redmine::Plugin.register :redmine_asset_tracker do
  ...
  #menu :application_menu, :new_asset, { :controller => 'assets', :action => 'new' }, :caption => 'New Asset'
  #menu :application_menu, :new_asset_type, { :controller => 'asset_types', :action => 'new' }, :caption => 'New Asset Type'
