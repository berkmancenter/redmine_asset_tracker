 ...
 *  http://groups.google.com/group/plugin_assets/redmine_asset_tracker/images/facebox/
 *
...
var Facebox = Class.create({
	initialize	: function(extra_set){
		this.settings = {
			loading_image	: '/plugin_assets/redmine_asset_tracker/images/facebox/loading.gif',
			close_image		: '/plugin_assets/redmine_asset_tracker/images/facebox/closelabel.gif',
	        ...
	        <tbody> \
	          ...
	          <tr> \
	            ...
	            <td class="body"> \
	              ...
	              <div class="footer"> \
	                <a href="#" class="close"> \
	                  <img src="/plugin_assets/redmine_asset_tracker/images/facebox/closelabel.gif" title="close" class="close_image" /> \
	                </a> \
	              </div> \
	            </td> \
	            <td class="b"/> \
